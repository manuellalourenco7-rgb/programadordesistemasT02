...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        Animal meuCachorro = new Cachorro { Nome = "Paco" };
        Animal meuGato = new Gato { Nome = "Lola" };

        //Chamando o método EmitirSom para cada animal
        meuCachorro.EmitirSom(); //Saída: Paco late: Au Au!
        meuGato.EmitirSom(); //Saída: Lola mia: Miau!

        //Utilizando Poliformismo: Array de animais
